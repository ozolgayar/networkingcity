...
function initStickyTooltip() {
 ...
 mTake.addEventListener('click', function() {
  ...
  if (shelfEl && !shelfEl.classList.contains('taken')) {
    ...
    var positions = [
  { left: '22%', top: '8%'  },  // 0 визитница    — левый верхний карман
  { left: '38%', top: '5%'  },  // 1 ручка        — центр верхний карман
  { left: '52%', top: '8%'  },  // 2 книжка       — правый верхний карман
  { left: '10%', top: '42%' },  // 3 салфетки     — левый центр
  { left: '28%', top: '48%' },  // 4 пятновыв.    — центр-лево
  { left: '44%', top: '44%' },  // 5 аптечка      — центр
  { left: '62%', top: '48%' },  // 6 конфеты      — центр-право
  { left: '12%', top: '68%' },  // 7 книга        — левый низ
  { left: '38%', top: '72%' },  // 8 зарядка      — центр низ
  { left: '58%', top: '68%' }   // 9 парфюм       — право низ
];
