...
function initStickyTooltip() {
 ...
 mTake.addEventListener('click', function() {
  ...
  { left: '10%', top: '42%' },  // 3 салфетки
  { left: '28%', top: '48%' },  // 4 пятновыв.
  { left: '44%', top: '44%' },  // 5 аптечка
  { left: '62%', top: '48%' },  // 6 конфеты
  { left: '18%', top: '63%' },  // 7 книга        ← подняли top и сдвинули right
  { left: '40%', top: '65%' },  // 8 зарядка      ← подняли top
  { left: '60%', top: '63%' }   // 9 парфюм       ← подняли top и сдвинули left
];
