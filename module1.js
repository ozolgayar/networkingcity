  ...
  var objects = [
    {
      name: 'Ресепшен',
      good: false,
      text: '❌ Ловушка! Люди у ресепшена только пришли: они нервничают, оглядываются, ищут знакомых. Если подойти к ним сейчас — они будут рассеяны и быстро уйдут «за напитком» или «поздороваться с кем-то». Дай им сначала освоиться.'
    },
    {
      name: 'Гардероб',
      good: false,
    ...
    },
    {
      ...
      good: true,
      text: '⭐ Стратегическая позиция! Люди подходят к закускам расслабленно, без спешки — они не заняты ничем важным. Это естественный повод начать разговор: «Вы уже пробовали вот это?» или просто встать рядом и улыбнуться. Один из лучших поводов для лёгкого старта.'
    },
    {
    ...
    },
    {
      name: 'Туалеты',
      good: false,
      text: '❌ Ловушка! Сходить — конечно, можно. Но торчать рядом — плохая идея. Это транзитная зона, людям здесь неловко, и вряд ли кто-то хочет знакомиться у двери в туалет.'
    }
  ];
